(function () {
  ...
  GameView.prototype.gameOverSequence = function () {
    ...
    function playAgainCallback () {
      ...
      this.canvas.addEventListener("click", newGame.bind(this));
    }
  ...
  var newGame = GameView.prototype.newGame = function () {
    this.canvas.removeEventListener('click', newGame, false);
